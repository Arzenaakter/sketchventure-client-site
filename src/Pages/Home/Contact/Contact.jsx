        ...
        <section className="bg-[#2D2D2D] text-[#000]  py-20 relative lg:px-0 px-10 ">
            <motion.div
                ...
                <div className="  bg-[#ED1C24]  z-10 md:w-[40%] w-[100%] p-5 md:-ms-16 shadow-xl space-y-3">
                    ...
                    <p className='flex  items-center gap-2'><CiLocationOn size={24} /> Bogura, Bangladesh </p>
                ...
                <div className="   md:w-[50%] w-[100%]   z-10 ">
                    <h4 className=" py-2 font-semibold text-xl mb-2 text-center md:text-start ">Contact Us </h4>
                    <form action="https://formspree.io/f/mzbldnbk" method="POST" className='text-center md:text-start py-3 md:py-0'>
                        ...
                        <input type="text" name="msg" id="" placeholder='Message' className='border-b-2 md:w-[82%] p-2 block  mx-auto md:mx-0'  />
